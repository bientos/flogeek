...
mysqldump: Got error: 1044: Access denied for user ''@'localhost' to database 'flogeek' when selecting the database
[gama@vps-1117201-13447 ~]$ mysqldump -u root --no-data flogeek
